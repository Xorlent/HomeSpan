...
* `static Color HSV(float h, float s, float v)`
  * equivalent to `return(Color().HSV(h,s,v,drivePercent));`
  * example: `WS2801_LED::Color c[]={WS2801_LED::HSV(120,100,100),WS2801_LED::HSV(60,100,100),WS2801_LED::HSV(0,100,100)};` to create a red-yellow-green traffic light pattern
